        ...
        <div class="header-top">
            <div class="header-top-right">
                <ul>
                    ...
                    <li class="dropdown"><a href="${pageContext.request.contextPath}/pages/login.jsp" title="LOGIN" class="dropdown-toggle">用户登录</a></li>
                    <li class="dropdown"><a href="${pageContext.request.contextPath}/pages/login_admin.jsp" title="LOGIN" class="dropdown-toggle">企业登录</a></li>
                    <li class="dropdown"><a href="${pageContext.request.contextPath}/pages/register.jsp" title="REGISTER" class="dropdown-toggle">注册个人账户</a></li>
                    <li class="dropdown"><a href="${pageContext.request.contextPath}/pages/register_admin.jsp" title="Register" class="dropdown-toggle">注册企业账户</a></li>
                    </c:if>
                    <c:if test="${not empty user}">
                        <font color="white">欢迎：${user.u_name}</font>
                        <a href="${pageContext.request.contextPath}/user/remove.do"><font color="orange">注销</font></a>
                    </c:if>
                </ul>
        ...
        <nav class="navbar navbar-fixed-top">
            <div class="container">
                <div class="navbar-header ">
                    ...
                    <a class="navbar-brand" href="#" title="Skyline"><img src="${pageContext.request.contextPath}/images/Home-1/sky-logo-header.png" alt="#"></a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown ">
                            <a href="#" title="Room & Rate" class="dropdown-toggle" data-toggle="dropdown">精美住房<b class="caret"></b></a>
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                <li><a href="${pageContext.request.contextPath}/room/findAll.do" title="">预定房间</a></li>
                            </ul>
                        </li>
                        <li class="dropdown ">
                            ...
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                ...
                                <li><a href="${pageContext.request.contextPath}/pages/tems_condition_1.jsp">注意事项</a></li>

                                <li><a href="${pageContext.request.contextPath}/pages/check_out.jsp" title="">账单交易</a></li>
                            </ul>
                        </li>
